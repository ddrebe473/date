...
let Oct= new Date('10,11,2009')
let Nov = new Date('11,10,2010')
console.log(new Intl.DateTimeFormat('en-US',{weekday:'long'}).format(Oct))
console.log(new Intl.DateTimeFormat('en-US',{weekday:'long'}).format(Nov))